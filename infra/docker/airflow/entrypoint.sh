...
: "${AIRFLOW__CORE__FERNET_KEY:?Set AIRFLOW__CORE__FERNET_KEY in the selected env file}"
: "${AIRFLOW__API__SECRET_KEY:?Set AIRFLOW__API__SECRET_KEY in the selected env file}"
: "${AIRFLOW__API_AUTH__JWT_SECRET:?Set AIRFLOW__API_AUTH__JWT_SECRET in the selected env file}"
